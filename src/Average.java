...
////  Create and implement a class named Averager containing:
...
//// The value of sum is increased by the value of the parameter and the value of count is incremented by one.
////A method named getCount that accepts no parameters. getCount returns the value of the count instance variable,
//// that is, the number of values added to sum.
